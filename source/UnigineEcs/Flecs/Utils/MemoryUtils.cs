...
namespace Flecs
{
    public unsafe struct UnmanagedStringBuffer : IDisposable
    {
        ...
        private const int NATURAL_ALIGNMENT = 16;
        private const int STR_ALIGN = 8;
        ...
        private static Header* AllocateHeader(int size = 4096)
        {
        ...
        private Span<byte> GetAvailableSpan(int requiredSize, out IntPtr startPtr)
        {
