...
namespace Flecs
{
    ...
    {
        private static Dictionary<IntPtr, Dictionary<string, TypeId>> typedefMap = new Dictionary<IntPtr, Dictionary<string, TypeId>>();
        private static Dictionary<IntPtr, Dictionary<int, TypeId>> typeMap = new Dictionary<IntPtr, Dictionary<int, TypeId>>();
        private static Dictionary<IntPtr, List<SystemActionDelegate>> systemActions = new Dictionary<IntPtr, List<SystemActionDelegate>>();
        private static Dictionary<int, CharPtr> unmanagedStrings = new Dictionary<int, CharPtr>();
        private static UnmanagedStringBuffer stringBuffer = UnmanagedStringBuffer.Create();
